        ...
        <div class="row justify-content-center">
            <div class="col-md-7 mt-5">
                ...
                <div class="card border-success">
                    <form action="{{ route('Estudiante.saveStuden')}}" method="POST" enctype="multipart/form-data">
                        @csrf

                        <div class="card-header border-primary text-center text-white" style="background-color: #5646"; >AGREGAR ESTUDIANTE</div>

                        <div class="card-body border-primary" style="background-color: #8565;">
                            <form>
                                ...
                                <div class="row form-group">
                                    <button type="submit" class="btn btn col-md-9 offset-2 text-dark mb-2" style="background-color: #e2e8f0;">Guardar</button>
