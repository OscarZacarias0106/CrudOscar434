        ...
        <div class="row justify-content-center">
            <div class="col-md-7 mt-5">
                ...
                <div class="card border-success">
                    <form action="{{ route('editStuden', $studen->carne)}}" method="POST" enctype="multipart/form-data">
                        @csrf @method('PATCH')
