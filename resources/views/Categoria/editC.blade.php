            ...
            <div class="col-md-7 mt-5">
                ...
                <div class="card border-success">
                    <form action="{{ route('categoria.update', $categoria->id_categoria)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-header border-success text-center text-white" style="background-color: #2d3748"; >MODIFICAR CATEGORIA</div>

                        <div class="card-body" style="background-color: #DD4455;">
                            ...
                            <div class="row form-group">
                                <button type="submit" class="btn btn col-md-9 offset-2 text-dark mb-2" style="background-color: #196F3D;">Modificar</button>
