            ...
            <div class="col-md-7 mt-5">
                ...
                <div class="card border-success">
                    <form action="{{ route('categoria.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-header border-success text-center text-white" style="background-color: #723"; >AGREGAR CATEGORIA</div>

                        <div class="card-body" style="background-color: #D345;">
                            ...
                            <div class="row form-group">
                                <button type="submit" class="btn btn col-md-9 offset-2 text-dark mb-2" style="background-color: #453;">Guardar</button>
